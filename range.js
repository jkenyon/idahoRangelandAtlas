...
require([
  ...
  "dojo/domReady!",
  "dojo/request"
], function (Map, esriConfig, MapView, FeatureLayer, GraphicsLayer, ImageryLayer, QueryTask, Query, SimpleFillSymbol, UniqueValueRenderer, RasterFunction, Graphic, Search, Compass, Locate, arrayUtils, dom, on, html, lang, request) {
  // Fixes CORS problems.
